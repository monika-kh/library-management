...
from library.views import (
    ...
    BorrowListCreateAPIView, BorrowReturnAPIView,
    UserListAPIView
)
...
urlpatterns = [
    ...
    path('api/borrows/', BorrowListCreateAPIView.as_view(), name='Borrow-list-create'),
    path('api/borrows/<int:pk>/return/', BorrowReturnAPIView.as_view(), name='Borrow-return'),
